...
void PE_low_level_init(void)
{
  ...
  /* ### I2C_LDD "I2CKomunikation_PI" component auto initialization. Auto initialization feature can be disabled by component property "Auto initialization". */
  (void)I2CKomunikation_PI_Init(NULL);
